...
log_length = 15 # minutes (можно вставлять выражения)
acceleration_delay = 500 # milliseconds

# ОВЕН
owen_inputs = [4, 4, 4, 4] # входы овена, список из 4-ех чисел от 1 до 8, развести
...
max_first_head_round = 10.0 # максимальное количество оборотов ШДГ1 об/мин
max_second_head_round = 10.0 # максимальное количество оборотов ШДГ2 об/мин
